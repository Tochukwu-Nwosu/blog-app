    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="px-2 sm:px-4 2xl:px-5 my-8 text-gray-800">
        ...
        <div className="my-4 flex flex-col gap-3 sm:text-lg 2xl:text-xl">
            ...
            <textarea name="body" id="body" value={body} required onChange={handleChange} className="resize-none px-3 py-2 border bg-white border-gray-400 rounded-md focus:outline-none focus:ring-1 focus:border-blue-400 focus:ring-blue-400"></textarea>
        </div>
